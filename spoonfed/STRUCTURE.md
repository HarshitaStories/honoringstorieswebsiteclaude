...
On Psychotherapy and Supervision below 640px, a phone-only copy of the relevant hero image
...
layouts. If either image path or alt text changes, update both copies in its page file.
